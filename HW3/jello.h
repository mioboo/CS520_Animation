...
extern double particleLength;
extern char *Integration;

//error in the constraints
extern double constraintsError;
...
extern int shear, bend, structural, pause, viewingMode, saveScreenToFile, Fx, Fy, Fa, Fb, PNoise;
...
struct world
{
  ...
  struct point p[999]; // position of the 512 control points
  struct point v[999]; // velocities of the 512 control points
  struct point a[999];
  struct point Force;
};
